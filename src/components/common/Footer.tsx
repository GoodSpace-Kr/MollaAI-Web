    ...
    <footer className="bg-surface py-20 px-6 md:px-12 border-t border-surface-container">
      ...
      <div className="max-w-7xl mx-auto mt-20 pt-8 border-t border-surface-container flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="relative group">
          <a className="text-xs text-on-surface-variant/40 hover:text-primary transition-colors font-medium cursor-pointer">
            개인정보 수집 및 이용약관
          </a>
            ...
            <div className="space-y-6">
              <section>
                ...
                <ul className="mt-2 ml-4 list-disc space-y-1 text-sm text-[#64748B]">
                  <li>
                    회원 관리 : 회원 가입, 본인 인증, 계정 관리, 부정 이용 방지
                  </li>
                  <li>
                  ...
                  <li>
                    서비스 개선 및 AI 학습 : 음성 데이터, 회화 데이터, 이용 패턴
                    분석을 통한 AI 모델 성능 개선 및 서비스 품질 향상
                  </li>
                  <li>
              ...
              <section>
                ...
                <ul className="mt-2 ml-4 list-disc space-y-1 text-sm text-[#64748B]">
                  <li>
                    회원 탈퇴 시 개인정보는 즉시 파기하는 것을 원칙으로 합니다.
                  </li>
                  <li>
                  ...
                  <li>
                    음성 데이터, 통화 기록 및 STT 데이터는 서비스 제공, AI 학습
                    및 품질 개선 목적 범위 내에서 보관될 수 있습니다.
                  </li>
                  <li>
              ...
              <section>
                ...
                <div>
                  Molla AI는 원활한 서비스 제공을 위해 아래와 같은 외부 서비스를
                  이용할 수 있습니다.
                </div>
              ...
              <section>
                ...
                <div>
                  Molla AI는 미성년자의 서비스 이용이 가능하며, 관련 법령에 따라
              ...
              <section>
                ...
                <div>
                  개인정보 보호 관련 문의는 아래 이메일로 연락해주시기 바랍니다.
                </div>
              ...
              <section>
                ...
                <div>
                  회사는 개인정보 처리방침을 변경할 수 있으며, 변경 시 서비스 내
                  공지사항 등을 통해 사전에 안내합니다.
                </div>
              </section>
            </div>
            <div
